...
const ThreeRandomSongs = () => {
  ...
  const threeRandomSongsUrl = `${import.meta.env.VITE_BACKEND_URL}/audify/search/randomsongs`;
  const playlistsUrl = `${import.meta.env.VITE_BACKEND_URL}/audify/playlists`;
  ...
  return (
    <div className='container custom-container pt-5 pb-5'>
      ...
      <div className='row'>
        {threeSongs.length > 0 ? (
          threeSongs.map((song) =>
            <div className='col-md-4 col-sm-12 col-12' key={song.trackId}>
